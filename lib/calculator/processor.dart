...
import 'package:sisterhood_app/calculator/key-controller.dart';
import 'package:sisterhood_app/calculator/key-symbol.dart';
...
abstract class Processor {
  ...
  static final StreamController _equalcontroller = StreamController();
  static Stream get _equalstream => _equalcontroller.stream;
  static StreamSubscription listenEqual(Function handler) =>
      _equalstream.listen(handler);
  ...
  static process(dynamic event) {
    CalculatorKey key = (event as CalKeyEvent).key;
